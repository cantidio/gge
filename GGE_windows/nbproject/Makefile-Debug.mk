...
LDLIBSOPTIONS=-lalleg -L../../gorgon++/Gorgon++_windows/dist/Debug/MinGW-Windows -lGorgon___windows ../../gorgon++/third_party/lua51.lib

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/MinGW-Windows/gge_windows.exe

dist/Debug/MinGW-Windows/gge_windows.exe: ../../gorgon++/Gorgon++_windows/dist/Debug/MinGW-Windows/libGorgon___windows.dll

dist/Debug/MinGW-Windows/gge_windows.exe: ../../gorgon++/third_party/lua51.lib

dist/Debug/MinGW-Windows/gge_windows.exe: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/MinGW-Windows
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/gge_windows ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
# Subprojects
.build-subprojects:
	cd ../../gorgon++/Gorgon++_windows && ${MAKE}  -f Makefile CONF=Debug

# Clean Targets
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/MinGW-Windows/gge_windows.exe

# Subprojects
.clean-subprojects:
	cd ../../gorgon++/Gorgon++_windows && ${MAKE}  -f Makefile CONF=Debug clean
